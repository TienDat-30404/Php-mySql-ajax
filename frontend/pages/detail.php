<?php 
    ...
    namePublisher FROM publishers LEFt JOIN products ON products.publisher_id = publishers.id LEFT JOIN product_authors ON products.id = product_authors.product_id 
    LEFT JOIN authors ON product_authors.author_id = authors.id WHERE products.id='$id_detail'";
